...
servername = 'news.gamene.org' #news.gamene.org  #news.foo.bar
#from nntplib import NNTP
#server=NNTP('news.gmane.org')
#server.group('gmane.comp.python.apple')
group = 'gmane.comp.python.apple'    #gmane.comp.python.apple #comp.lang.python.announce  
